...
DEFAULT_LOGGER_CONFIG = {
    ...
    "formatters": {
        ...
        "colored": {
            "()": "api_template.loggers.formatters.ColoredFormatter",
    ...
    "filters": {
        "info": {
            "()": "api_template.loggers.filters.InfoFilter",
        },
        "cwd": {
            "()": "api_template.loggers.filters.CwdFilter",
        },
        # "path_shortener": {
        #     "()": "api_template.loggers.filters.PathShortenerFilter",
        # }
    },
    "handlers": {
        "console": {
